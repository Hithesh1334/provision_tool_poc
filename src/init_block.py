...
def init_block():
    ...
    st.divider()
    st.markdown("<p id='env_comment'>Tip : Domain name mentioned will be used to create database names. Example : Domain Name - Marketing, DB Name : MARKETING_PROD,MARKETING_DEV etc</p>",unsafe_allow_html=True)
    col1, col2 = st.columns([2,1 ])
    with col1:
