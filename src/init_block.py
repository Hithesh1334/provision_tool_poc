...
def init_block():
    ...
    st.divider()
    st.markdown("<p id='env_comment'>Tip: Business domain name will be used to generate database name. Example : MARKETING_PROD, MARKETING_QA</p>",unsafe_allow_html=True)
    col1, col2 = st.columns([2,1 ])
    with col1:
